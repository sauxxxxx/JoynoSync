...
This is not product status. For current shipped state, use [Project_state.md](Project_state.md).
...
### Main views
- [public/src/views/crm.js](public\src\views\crm.js)
...
- [public/src/views/extended.js](public\src\views\extended.js)
  - dashboard widgets
  - calls performance
  - extra operational views
- [public/src/views/settings.js](public\src\views\settings.js)
  - settings/profile pages
- [public/src/views/integrations.js](public\src\views\integrations.js)
  - RingCentral status card and three-step JWT/RingOut setup workflow

### Shared frontend modules
- [public/src/supabase/crm.js](public\src\supabase\crm.js)
  - CRM Supabase queries
  - performance/event fetches
- [public/src/supabase/attendance.js](public\src\supabase\attendance.js)
  - attendance-specific Supabase calls
- [public/src/supabase/notifications.js](public\src\supabase\notifications.js)
  - notifications fetch/read helpers
- [public/src/supabase/integrations.js](public\src\supabase\integrations.js)
  - provider status and connection actions
- [public/src/modules/query-cache.js](public\src\modules\query-cache.js)
  - in-memory response cache
- [public/src/modules/cache-keys.js](public\src\modules\cache-keys.js)
  - stable cache keys for list/detail routes
- [public/src/modules/confirm-modal.js](public\src\modules\confirm-modal.js)
  - shared confirm modal controller
- [public/src/modules/attendance-manual.js](public\src\modules\attendance-manual.js)
...
- [public/src/modules/messenger-controller.js](public\src\modules\messenger-controller.js)
  - standalone Messenger interaction controller
  - owner for Messenger actions and composer flow
- [public/src/modules/messenger-realtime.js](public\src\modules\messenger-realtime.js)
...
### CSS ownership
- [public/styles/sections/layout.css](public\styles\sections\layout.css)
  - app shell
  - buttons
  - topbar
  - nav
  - shared chrome
- [public/styles/sections/crm-attendance.css](public\styles\sections\crm-attendance.css)
  - CRM tables
  - Leads table
  - attendance tables
  - bulk bars
...
- [public/styles/sections/comms.css](public\styles\sections\comms.css)
  - calls
  - SMS/email surfaces
...
- [public/styles/sections/integrations.css](public\styles\sections\integrations.css)
  - integrations page, provider health, and responsive states
- [public/styles/sections/ringcentral-setup.css](public\styles\sections\ringcentral-setup.css)
  - RingCentral setup modal, mapping table, and workflow choices
- [public/styles/sections/ringcentral-setup-responsive.css](public\styles\sections\ringcentral-setup-responsive.css)
  - RingCentral tablet and mobile setup behavior
- [public/styles/sections/integration-marketplace.css](public\styles\sections\integration-marketplace.css)
  - featured provider and available integration marketplace layout
- [public/styles/sections/integration-marketplace-responsive.css](public\styles\sections\integration-marketplace-responsive.css)
  - marketplace dark mode and responsive behavior
...
- [supabase/functions](supabase\functions)
  ...
  - `ringcentral-agent-mappings` owns JoynoSync user-to-extension mappings and call workflow policy

## Fast Path: Where To Look First

### Small CRM UI tweak
1. [public/src/views/crm.js](public\src\views\crm.js)
2. [public/styles/sections/crm-attendance.css](public\styles\sections\crm-attendance.css)
3. If interaction/save is broken, then [public/src/app.js](public\src\app.js)

### Modal copy or modal spacing
1. open/render logic in [public/src/app.js](public\src\app.js)
2. confirm modal controller in [public/src/modules/confirm-modal.js](public\src\modules\confirm-modal.js)
2. styles in [public/styles/sections/modals.css](public\styles\sections\modals.css)

### Dashboard card or layout issue
1. [public/src/views/extended.js](public\src\views\extended.js)
2. [public/styles/sections/dashboard-work.css](public\styles\sections\dashboard-work.css)

### Attendance bug
1. render/UI in [public/src/views/attendance-upgrade.js](public\src\views\attendance-upgrade.js)
2. attendance manual flow in [public/src/modules/attendance-manual.js](public\src\modules\attendance-manual.js)
3. action/save path in [public/src/app.js](public\src\app.js)
4. policy math in [public/src/modules/attendance-core.js](public\src\modules\attendance-core.js)
5. Supabase call in [public/src/supabase/attendance.js](public\src\supabase\attendance.js)
6. SQL RPC in [supabase/migrations](supabase\migrations)

### Calls performance issue
1. [public/src/views/extended.js](public\src\views\extended.js)
2. [public/src/app.js](public\src\app.js)
3. [public/src/supabase/crm.js](public\src\supabase\crm.js)

### Import / duplicate detection issue
1. shared frontend policy in [public/src/modules/lead-import-policy.js](public\src\modules\lead-import-policy.js)
2. frontend review/orchestration in [public/src/app.js](public\src\app.js)
3. backend duplicate logic in [supabase/functions/_shared/lead_import.ts](supabase\functions\_shared\lead_import.ts)
3. commit/worker functions in:
   - [supabase/functions/lead-import-worker/index.ts](supabase\functions\lead-import-worker\index.ts)
   - [supabase/functions/lead-import-commit/index.ts](supabase\functions\lead-import-commit\index.ts)
...
- modal opens from [public/src/app.js](public\src\app.js)
...
- [public/src/app.js](public\src\app.js) is the real interaction hub for many surfaces even when the markup lives in a view file.
...
- create migration under [supabase/migrations](supabase\migrations)
