...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const providerResult = await ringCentralRequest(`${getTelephonyPartyPath(callLog)}/reject`, {
      method: "POST"
    });
    ...
    console.error("ringcentral-decline-call failed", error);
